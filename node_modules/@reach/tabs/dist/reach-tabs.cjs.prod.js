...
var _createContext = /*#__PURE__*/context.createContext("Tabs"),
    TabsProvider = _createContext[0],
    useTabsCtx = _createContext[1];
...
var Tabs = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var _React$useRef = React.useRef(controlledIndex !== undefined),
      isControlled = _React$useRef.current;

  var id = autoId.useId(props.id || "tabs");
  ...
  var onFocusPanel = React.useCallback(function () {
  ...
  var onSelectTabWithKeyboard = React.useCallback(function (index) {
    var _tabs$index;

    var tabElement = (_tabs$index = tabs[index]) == null ? void 0 : _tabs$index.element;
    var doc = ownerDocument.getOwnerDocument(tabElement);

    if (keyboardActivation === exports.TabsKeyboardActivation.Auto) {
      onChange && onChange(index);
      setSelectedIndex(index);
    }

    if (tabElement && tabElement !== doc.activeElement && typeCheck.isFunction(tabElement.focus)) {
      tabElement.focus();
    }
  ...
  return /*#__PURE__*/React.createElement(descendants.DescendantProvider, {
    ...
    onSelectTab: readOnly ? noop.noop : onSelectTab,
    onSelectTabWithKeyboard: readOnly ? noop.noop : onSelectTabWithKeyboard,
...
var TabListImpl = /*#__PURE__*/React.forwardRef(function (_ref2, forwardedRef) {
  ...
  var _useTabsCtx = useTabsCtx("TabList"),
      focusedIndex = _useTabsCtx.focusedIndex,
      isControlled = _useTabsCtx.isControlled,
      isRTL = _useTabsCtx.isRTL,
      keyboardActivation = _useTabsCtx.keyboardActivation,
      onSelectTabWithKeyboard = _useTabsCtx.onSelectTabWithKeyboard,
      orientation = _useTabsCtx.orientation,
      selectedIndex = _useTabsCtx.selectedIndex,
      setSelectedIndex = _useTabsCtx.setSelectedIndex;
...
var Tab = /*#__PURE__*/React.forwardRef(function (_ref3, forwardedRef) {
  ...
  var _useTabsCtx2 = useTabsCtx("Tab"),
      tabsId = _useTabsCtx2.id,
      onSelectTab = _useTabsCtx2.onSelectTab,
      orientation = _useTabsCtx2.orientation,
      selectedIndex = _useTabsCtx2.selectedIndex,
      setFocusedIndex = _useTabsCtx2.setFocusedIndex;
...
var TabPanel = /*#__PURE__*/React.forwardRef(function (_ref5, forwardedRef) {
  ...
  var _useTabsCtx3 = useTabsCtx("TabPanel"),
      selectedPanelRef = _useTabsCtx3.selectedPanelRef,
      selectedIndex = _useTabsCtx3.selectedIndex,
      tabsId = _useTabsCtx3.id;
...
function useTabsContext() {
  var _useTabsCtx4 = useTabsCtx("useTabsContext"),
      focusedIndex = _useTabsCtx4.focusedIndex,
      id = _useTabsCtx4.id,
      selectedIndex = _useTabsCtx4.selectedIndex;
